        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">AEPS Services Commission</h3>
                    </div>
...
<script>
  ...
  function Delete(id) {
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('aeps2/PaySprintAepsController/delete/')?>" + id,
...
var $addCommissionForm = $('#addCommissionForm');
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('aeps2/PaySprintAepsController/edit/') ?>" + id,
        ...
        var role_id = $('#role').val();
            $.ajax({
              url: '<?php echo base_url('aeps2/PaySprintAepsController/addupdate'); ?>',
              type: 'POST',
