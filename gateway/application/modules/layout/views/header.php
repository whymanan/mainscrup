...
// }
$query = "SELECT `msg` as `notification_title`,`create` as `log_date`,`id` as `notification_id`  FROM `manual_notify` AS `menu` Where `role`=".$this->session->userdata('user_roles')." ";
  ...
  <div class="container-fluid">
   ...
   <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden notify">
            <div class="px-3 py-3">
...
<div class="wallet" style="width: 205px;margin-right: -93px;">
          <a href="#" class="row" style="color:white;">
              <div class="col-2">
                 <i style="font-size:30px;padding-top: 9px;" class="fas fa-wallet"></i>
               </div>
               <div class="col-10">
                 <span style="font-size: 14px;">&#x20B9 <?php echo $bal;?></span>
                 <p style="line-height:5px">Balance</p>
                </div>
          </a>
        </div>
      <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
