    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-lg-7 col-md-10">
                ...
                <p class="text-white mt-0 mb-5">This is your ITR Bussiness page. You can see the progress you've
    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="heading-small text-muted mb-4">ITR Bussiness</h6>
                    ...
                    <div class="pl-lg-4">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php if(isset($gst_details->member_id)){echo $gst_details->member_id;} ?>"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php if(isset($gst_details->referance_number)){echo $gst_details->referance_number; } ?>"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $gst_details->mobile ?>"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php if(isset($gst_details->email)){echo $gst_details->email; } ?>"
                                        readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Anual Income</label>
                                    <input type="text" class="form-control" required
                                        value="<?php echo $gst_details->annualincome ?>" readonly>
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Bussiness Details</label>
                                    <input type="textarea" class="form-control" required
                                        value="<?php echo $gst_details->business_details ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Bussiness details</label>
                                    <img height="100px"
                                        src="<?php  echo base_url('uploads/gst/documents/').$gst_details->business_details_file;?> ">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <img height="100px"
                                        src="<?php  echo base_url('uploads/gst/documents/').$gst_details->pancard;?> ">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Adharcard(font)</label>
                                    <img height="100px"
                                        src="<?php  echo base_url('uploads/gst/documents/').$gst_details->adharcardf;?> ">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Adharcard(back)</label>
                                    <img height="100px"
                                        src="<?php  echo base_url('uploads/gst/documents/').$gst_details->adharcardb;?> ">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <img height="100px"
                                        src="<?php  echo base_url('uploads/gst/documents/').$gst_details->photo;?> ">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url('legalservice/LegalController/gst_reject')?>">
                        <div class="form-group">
                            ...
                            <input type="text" name="gst_massage" value="" placeholder="why reject" class="form-control"
                                required>
        ...
        function(response) {
            ...
            if (response.status == "captured") {
                ...
                var data = {
                    ...
                    response: response,
                    gst_refrence_id: gst_refrence_id,
                    gst_id: gst_id
                };
