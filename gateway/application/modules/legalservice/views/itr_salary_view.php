        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    ...
                    <p class="text-white mt-0 mb-5">This is your ITR SALARY page. You can see the progress you've
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="heading-small text-muted mb-4">ITR SALARY</h6>
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <img height="100px" src="<?php  echo base_url('uploads/gst/documents/').$gst_details->salary;?> ">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
