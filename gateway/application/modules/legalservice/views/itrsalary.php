...
<form method="post" id="filter" action="<?php echo base_url('legalservice/LegalController/itr_salary')?>" enctype="multipart/form-data"> 
    <div class="row"> 
        <div class="col-lg-12 card card-body"> 
            <span>ITR Salary</span>

                <div class="row">

                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                    <input type="hidden" name="service_id" value="58">
                    <input type="hidden" name="service_type" value="itr_salary">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label class="form-control-label" for="example3cols1Input">Salary
                            </label>
                            <input type="file" class="form-control" name="salary" placeholder="" required>
                        </div>
                    </div>
                    <div class="row">
