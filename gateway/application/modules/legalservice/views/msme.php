...
<form method="post" id="filter" action="<?php echo base_url('legalservice/LegalController/msme_regi')?>" enctype="multipart/form-data"> 
    <div class="row"> 
        <div class="col-lg-12 card card-body"> 
            <span>MSME Registration</span>
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="service_type" value="msme">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control" name="bussinessdetails" placeholder="">
                        </div>
                         <div class="col-lg-6 col-md-6 col-sm-12">
                            <label class="form-control-label" for="example3cols1Input">Bussiness Details
                            </label>
                            <input type="file" class="form-control" name="bussinessdetailsf" placeholder="">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-5">
                            <label class="form-control-label" for="example3cols1Input">Bank Statement
                            </label>
                            <input type="file" class="form-control" name="bankstatement" placeholder="" required>
                         </div>
                    </div>
                <hr>
