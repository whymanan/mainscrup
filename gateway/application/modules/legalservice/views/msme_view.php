        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    ...
                    <p class="text-white mt-0 mb-5">This is your MSME page. You can see the progress you've
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="heading-small text-muted mb-4">MSME Registation</h6>
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php if(isset($gst_details->member_id)){echo $gst_details->member_id;} ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php if(isset($gst_details->referance_number)){echo $gst_details->referance_number; } ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php if(isset($gst_details->email)){echo $gst_details->email; } ?>" readonly>
                                    </div>
                                </div>
                         ...
                         <div class="pl-lg-4">
                             <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Bussiness details</label>
                                        <img height="100px" src="<?php  echo base_url('uploads/gst/documents/').$gst_details->business_details_file;?> ">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Pancard</label>
                                       <img height="100px" src="<?php  echo base_url('uploads/gst/documents/').$gst_details->pancard;?> ">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Adharcard(font)</label>
                                       <img height="100px" src="<?php  echo base_url('uploads/gst/documents/').$gst_details->adharcardf;?> ">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Adharcard(back)</label>
                                       <img height="100px" src="<?php  echo base_url('uploads/gst/documents/').$gst_details->adharcardb;?> ">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Photo</label>
                                       <img height="100px" src="<?php  echo base_url('uploads/gst/documents/').$gst_details->photo;?> ">
                                    </div>
                                </div>
                            </div>
                         </div>
