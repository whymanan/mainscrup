        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    <h1 class="display-2 text-white">Hello <?php  echo $gst_details->firm_name;?></h1>
                    <p class="text-white mt-0 mb-5">This is your GST Registration page. You can see the progress you've
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="heading-small text-muted mb-4">Gst information</h6>
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php  echo $gst_details->firm_name ?>" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php echo $gst_details->district ?>" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <?php if($gst_details->company_type=="privatelimited"){ ?>
                                <div class="col-lg-4">
                                    <div class="container">
                                        <h5 class="h3 mb-0">Certificate Of incorporation</h5>
                                        <hr>
                                        <?php if(isset($gst_details->certificate_of_incorporation)) { ?>
                                        <img id="blah3"
                                            src="<?php  echo base_url('uploads/gst/documents/'). $gst_details->certificate_of_incorporation ;?>"
                                            alt="your image" width="150px" />
                                        <?php }else { echo  '<p class=" mb-0"> Certificate Of incorporation Not Uploaded</p>'; } ?>
                                    </div>
                                </div>
                                <?php } ?>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="container">
                                        <h5 class="h3 mb-0">Rent Agreement</h5>
                                        <hr>
                                        <div class="container">
                                            <?php if(isset($gst_details->rent_agreement)){ ?>
                                            <img src="<?php echo base_url('/uploads/gst/documents/'). $gst_details->rent_agreement ; ?>"
                                                alt="your image" width="150px" />
                                            <?php } else { echo  '<p class=" mb-0">Rent Agreement Not Uploaded</p>'; } ?>
                                        </div>
                                    </div>
                                </div>
