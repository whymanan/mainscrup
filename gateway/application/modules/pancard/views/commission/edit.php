<div class="card card-body">
    <form method="post" id="filter" action="<?php echo base_url('pancard/pancard/update'); ?>">
        <div class="form-row">
            <div class="row">
                <div class="col-2">
            ...
            <div class="col-2">
              ...
              <input type="hidden" id="service_commission_id"  name="service_commission_id" class='btn btn-primary' value="64"  required>
