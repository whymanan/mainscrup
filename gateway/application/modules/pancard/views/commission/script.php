    ...
    $(document).ready(function() {
        ...
        body.on('change', 'select[name="user_role"]', function() {
          ...
          if (typeof onload !== 'undefined' && onload) {
            ...
            $.ajax({
              url: '<?php echo base_url('pancard/pancard/addCommissionForm'); ?>',
              type: 'POST',
              data: {"CommissionForm": onload, "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"},
              beforeSend: function(){
        ...
        body.on('change', 'select[name="user_role"]', function() {
             ...
             var Api = '<?php echo base_url('pancard/pancard/get_list'); ?>';
             var $squadlist = $('#list');
