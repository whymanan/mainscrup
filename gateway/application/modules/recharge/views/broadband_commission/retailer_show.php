        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Services Commission</h3>
                    </div>
                          ...
                          <div class="form-group">
                              ...
                              <select name="user_role" id="role" class="form-control" required>
                                  <option value="">Select Service</option>
                                   <?php foreach($services as $value){ if($value['id']>2 && $value['id']<=6||$value['id']>=48||$value['id']==40||$value['id']==1||$value['id']==8){ continue;}?>
...
<script>
  ...
  function Delete(id) {
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('recharge/RechargeController/broadband_commissiondelete/')?>" + id,
...
var $addCommissionForm = $('#addCommissionForm');
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('recharge/RechargeController/broadband_commissionedit/') ?>" + id,
        ...
        var role_id = $('#role').val();
            $.ajax({
              url: '<?php echo base_url('recharge/RechargeController/broadband_commissionaddupdate'); ?>',
              type: 'POST',
