        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Cable Bill Pay</h3>
                    </div>
                ...
                <form name="validate" role="form" action="<?php echo base_url('recharge/bill_submit'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label">Service Provider</label>
                                        <select name="operator" id="operator" class="form-control select2">
                                            ...
                                            <option value="246">Asianet Digital</option>
                                            <option value="60">Hathway Digital TV</option>
                                            <option value="61">Incable Digital TV</option>
                                            <option value="498">INDigital	</option>
                                            <option value="364">Intermedia Cable Communication Pvt Ltd</option>
                                        </select>
                                </div>
                            </div>
                    ...
                    <div  id="submit">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                         ...
                         <input type="hidden" id="recharge_type" name="type" value="cable">
                         <input type="hidden"  id="serviceid" name="service" value="43">
