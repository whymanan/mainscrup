        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">DataCard Bill Pay</h3>
                    </div>
                ...
                <form name="validate" role="form" action="<?php echo base_url('recharge/bill_submit'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="col-lg-12">
                            ...
                            <select name="operator" id="operator" class="form-control">
                                <option value="321">Jio Fi (Prepaid)</option>
                            </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div >
                        ...
                        <input type="hidden" id="recharge_type" name="type" value="datacard">
                         <input type="hidden" id="serviceid" name="service" value="14">
                    </div>
