        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Electricity Commission</h3>
                    </div>
...
<script>
  ...
  function Delete(id) {
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('recharge/RechargeController/electricity_commissiondelete/')?>" + id,
...
var $addCommissionForm = $('#addCommissionForm');
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('recharge/RechargeController/electricity_commissionedit/') ?>" + id,
        ...
        var role_id = $('#role').val();
            $.ajax({
              url: '<?php echo base_url('recharge/RechargeController/electricity_commissionaddupdate'); ?>',
              type: 'POST',
