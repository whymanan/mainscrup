...
<script type="text/javascript">
    ...
    //     getlist(query);
      ...
      body.on('change', 'select[name="user_role"]', function() {
          ...
          if (typeof onload !== 'undefined' && onload) {
            ...
            $.ajax({
              url: '<?php echo base_url('recharge/RechargeController/electricity_CommissionForm'); ?>',
              type: 'POST',
  ...
  body.on('change', 'select[name="user_role"]', function() {
    ...
    body.on('change', 'select[name="user_role"]', function() {
         ...
         var Api = '<?php echo base_url('recharge/RechargeController/electricity_get_list'); ?>';
         var $squadlist = $('#list');
