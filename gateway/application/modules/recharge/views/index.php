 ...
 <div>
  <div class="row">
      ...
      <div class="card card-stats border border-primary node " data-info="new">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="row">
                <div class="col-12 text-center text-info font"> MOBILE</div>
            </div>        
        </div>
        </a>
      </div>
    ...
    <div class="col-xl-3 col-md-4">
      <div class="card card-stats border border-primary" data-info="new">
        ...
        <div class="card-body">
         <div class="row">
                ...
                <div class="row"> 
                <div class="col-12 text-center text-info font"> DTH</div>
            </div>
      ...
      <div class="card card-stats border border-primary node" data-info="new">
        ...
        <div class="card-body">
         <div class="row">
                ...
                <div class="row">
                <div class="col-12 text-center text-info font"> DATA CARD</div>
            </div>
        </div>
        </a>
      </div>
     ...
     <div class="col-xl-3 col-md-4">
      <div class="card card-stats border border-primary node" data-info="new">
        ...
        <div class="row">
                ...
                <div class="row">
                <div class="col-12 text-center text-info font">LANDLINE</div>
            </div>
        </div> </a>
      </div>
    </div>
     <div class="col-xl-3 col-md-4">
      <div class="card card-stats border border-primary node" data-info="new">
        ...
        <div class="row">
                ...
                <div class="row">
                <div class="col-12 text-center text-info font">ELECTRICITY</div>
            </div>
        </div> </a>
      </div>
    </div>
     <div class="col-xl-3 col-md-4">
      <div class="card card-stats border border-primary node" data-info="new">
        <!-- Card body --> 
        <a href="<?php echo base_url('recharge/gas')?>">
        <div class="card-body">
        <div class="row">
                <div class="col-12 text-center text-info"> <i class="fa fa-fire fa-5x" aria-hidden="true"></i></div>
            </div>
                <div class="row">
                <div class="col-12 text-center text-info font"> GAS</div>
            </div>
        </div>
        </a>
      </div>
     ...
     <div class="col-xl-3 col-md-4">
      <div class="card card-stats border border-primary node" data-info="new">
        <!-- Card body --> 
        <a href="<?php echo base_url('recharge/emi')?>">
        <div class="card-body">
        <div class="row">
                <div class="col-12 text-center text-info"> <i class="fa fa-hand-holding-usd fa-5x" aria-hidden="true"></i></div>
            </div>
                <div class="row">
                <div class="col-12 text-center text-info font"> EMI</div>
            </div>
        </div>
        </a>
      </div>
      ...
      <div class="card card-stats border border-primary node" data-info="new">
        <!-- Card body --> 
        <a href="<?php echo base_url('recharge/broadband')?>">
        <div class="card-body">
        <div class="row">
                <div class="col-12 text-center text-info"> <i class="fa fa-broadcast-tower fa-5x" aria-hidden="true"></i></div>
            </div>
                <div class="row">
                <div class="col-12 text-center text-info font">Broadband</div>
            </div>
        </div>
        </a>
      </div>
  ...
  <div class="row" ng-controller="squad">
      ...
      <div class="card card-stats border border-primary node" data-info="new">
        <!-- Card body --> 
        <a href="<?php echo base_url('recharge/cable')?>">
        <div class="card-body">
        <div class="row">
                <div class="col-12 text-center text-info"> <i class="fa fa-tv fa-5x" aria-hidden="true"></i></div>
            </div>
                <div class="row">
                <div class="col-12 text-center text-info font">Cable</div>
            </div>
        </div>
        </a>
      </div>
      ...
      <div class="card card-stats border border-primary node" data-info="new">
        ...
        <div class="row">
                ...
                <div class="row">
                <div class="col-12 text-center text-info font"> WATER</div>
            </div>
        </div> </a>
      </div>
    </div>
      ...
      <div class="card card-stats border border-primary node" data-info="new">
        ...
        <div class="row">
                ...
                <div class="row">
                <div class="col-12 text-center text-info font"> INSURANCE</div>
            </div>
        </div>
      </div> </a>
    </div>
