        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Municipality Bill Pay</h3>
                    </div>
                ...
                <form name="validate" role="form" action="<?php echo base_url('recharge/bill_submit'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Service Provider</label>
                                        ...
                                        <option value="391">Greater Chennai Corporation</option>
                                        <option value="448">Gulbarga City Corporation</option>
                                        <option value="411">Hubli-Dharwad Municipal Corporation</option>
                                        <option value="215">Kalyan Dombivali Municipal Corporation</option>
                                        <option value="379">Kolhapur Municipal Corporation - Water Tax</option>
                                        <option value="214">Madhya Pradesh Urban (e-Nagarpalika) - Property</option>
                                        <option value="398">Minicipal Corporation - Meerut</option>
                                        <option value="419">Municipal Corporation Rohtak</option>
                                        <option value="397">Nagar Nigam Agra</option>
                                        <option value="399">Nagar Palika Parishad Lalitpur</option>
                                        <option value="361">Orange Retail Finance India Pvt Ltd</option>
                                        <option value="287">Port Blair Municipal Council</option>
                                        <option value="229">Prayagraj Nagar Nigam - Property</option>
                                        <option value="449">Puducherry Urban Development Agency(LAD)-Property Tax</option>
                                        <option value="414">Rajkot Municipal Corporation</option>
                                        <option value="375">Shivamogga City Corporation</option>
                                        <option value="460">UDD Uttarakhand</option>
                                        <option value="441">Vasai Virar Municipal Corporation - Property</option>
                                        </select>
                                </div>
                            </div>
                              ...
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Shop Id/Property Id/Customer Number</label>
                    ...
                    <div  id="submit">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                         ...
                         <input type="hidden" id="recharge_type"  name="type" value="municipal">
                         <input type="hidden" id="serviceid" name="service" value="46">
