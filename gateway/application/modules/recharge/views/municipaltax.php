        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Municipal Tax Bill Pay</h3>
                    </div>
                ...
                <form name="validate" role="form" action="<?php echo base_url('recharge/bill_submit'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Service Provider</label>
                                        ...
                                        <option value="481">Bicholim Municipal council</option>
                                        <option value="482">Canacona Municipal council</option>
                                        <option value="472">Corporation of City Panaji</option>
                                        <option value="485">Cuncolim Municipal counci</option>
                                        <option value="482">Curchorem Cacora Municipal council</option>
                                        <option value="473">Margao Municipal Council</option>
                                        <option value="474">Mhapsa Municipal Council</option>
                                        <option value="475">Mormugao Municipal Council</option>
                                        <option value="478">Pernem Municipal council</option>
                                        <option value="476">Ponda Municipal Council</option>
                                        <option value="480">Quepem Municipal council</option>
                                        <option value="483">Sanguem Municipal council</option>
                                        <option value="477">Sankhali Municipal council</option>
                                        <option value="479">Valpoi Municipal council</option>
                                        </select>
                                </div>
                            </div>
                    ...
                    <div  id="submit">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                         ...
                         <input type="hidden" id="recharge_type" name="type" value="mtax">
                         <input type="hidden"id="serviceid"  name="mtax" value="45">
