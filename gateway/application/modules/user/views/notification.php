        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                    <h4 class="heading-small text-muted mb-4">Notification</h4>
                    </div>
            ...
            <div class="card-body">
                <form name="validate" role="form" action="<?php echo base_url('user/send/notify'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                    <div class="pl-lg-4">

                        <div class="row">
                            <div class="col-sm-2" >

                                <label class="form-control-label">Role Id
                                        <button type="button" class="btn btn-sm btn-link" data-toggle="tooltip" data-placement="top" title="Select the Role for Send Notify">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <p > Notification <span style="color:red;"> * </span> </p>
                            </div>
                            <div class="col-sm-10">
                               
                                     <input name="notification" type="text" id="" class="form-control" required>
