                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class=" mb-1"> User Id: <?php echo $user[0]['member_id']?></p>
                      <p class=" mb-1"> Mobile: <?php echo $user[0]['phone']?></p>
                      <p class="text-muted font-size-sm"><?php echo $user[0]['address']?></p>
                      <button class="btn btn-primary">Follow</button>
                      <button class="btn btn-outline-primary">Message</button>
                      <button class="btn btn-outline-primary" data-toggle="modal" data-target="#modal-change-password" onclick="sent_otp()">Change Password</button>
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="">https://atmoonpe.com/</span>
                  </li>
                  <!--<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300" >
                            User Id <i class="ni location_pin mr-2"></i><?php echo ($user[0]['member_id'])  ?>
                        </div>
                          <div class="h5 font-weight-300">
                        ...
                        <button class="btn btn-outline-primary" data-toggle="modal" data-target="#modal-change-password" onclick="sent_otp()">Change Password</button>
                        <button class="btn btn-primary" id="getcert">Get Certificate</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label">PAN Number/
                                            पैन नंबर</label>
                                        <input type="text" id="pancard" name="pancard" class="form-control uppercase" value="<?php echo $user[0]['pan'] ?>" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="address" id="shopaddress" class="form-control" required   value="<?php echo $user[0]['address'] ?>" type="text" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<div class="modal fade" id="modal-change-password" tabindex="-1" role="dialog" aria-labelledby="modal-default" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
    <div class="modal-content">
      ...
      <!--            </div>-->
      <!--            <input class="form-control" placeholder="Enter Your Password" name="old_password" id="old_password" type="text" required>-->
      ...
      <!--            <input class="form-control" placeholder="Enter Your New Password" name="password" type="text" required>-->
      <!--            <input class="form-control" value="<?php echo $this->session->userdata('user_id') ?>" name="user_id" type="hidden" required >-->
...
<script>
    ...
    $('#otp').click(function()
    {
        ...
        var temp='<form name="changePasswordForm">'+
        '<div class="modal-body">'+
          '<div class="row">'+
            '<div class="col-md-12">'+
              '<div class="form-group">'+
      ...
      '</form>';
        $.ajax(
            {
                url:'<?php echo base_url("user/otp_verify")?>',
                type:"POST",
    ...
    $(document).ready(function() {
        ...
        $('#old_password').on('change', function(){
            ...
            $.ajax({
            url: '<?php echo base_url('users/checkpass/'); ?>'+pass,
            processData: false,
            contentType: false,
            success: function(data) {
            if (data==1) {
        ...
        body.on('submit', 'form[name="changePasswordForm"]', function(event){
    ...
    function sent_otp()
    {
        ...
        var phone=<?php echo $this->session->userdata('phone')?>;
         $.ajax(
            {
                url:'<?php echo base_url("user/otp_send")?>',
                type:"POST",
